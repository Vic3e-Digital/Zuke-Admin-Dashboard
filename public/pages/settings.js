...
//         const prefix = platform === 'facebook' ? 'fb' : platform === 'instagram' ? 'ig' : 'li';
...
//       console.log(`[Settings] ${platform} settings:`, settings); // Debug log
...
//             const pageName = document.getElementById('fbPageName'); // ✅ NEW  
//           const pageId = document.getElementById('fbPageId');
//           const nodeId = document.getElementById('fbNodeId');
//           const expiry = document.getElementById('fbExpiry');
          
//           if (pageName) pageName.textContent = settings.page_name || '—'; // ✅ NEW
//           if (pageId) pageId.textContent = settings.page_id || '—';
//           if (nodeId) nodeId.value = settings.n8n_node_id || '';
...
//           const nodeId = document.getElementById('igNodeId');
...
//           const profileId = document.getElementById('liProfileId');
//           const nodeId = document.getElementById('liNodeId');
//           const expiry = document.getElementById('liExpiry');
          
//           if (profileId) profileId.textContent = settings.profile_id || '—';
//           if (nodeId) nodeId.value = settings.n8n_node_id || '';
//           if (expiry && settings.expires_at) {
//             expiry.textContent = new Date(settings.expires_at).toLocaleDateString();
//           }
...
//           }
//         } else if (platform === 'instagram') {
//           // ✅ NEW: Populate Instagram account details
